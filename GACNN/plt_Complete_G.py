...
loader_train, loader_test = data_preprocessing(dataset_path=r"D:\Users\hcy\PycharmProjects\GNN_FD-main\图神经网络故障诊断\cwru",sample_number=20,dir_path='12DE',
                             window_size=1024,overlap=1024,normalization='Max-Min Normalization',noise=0,snr=0,input_type='FD',
                             graph_type='complete_graph',K=4,p=0.5, n=4,node_num=10,direction='undirected',edge_type='Gaussian kernel',
                             edge_norm=True,batch_size=32,train_size=0.6)

#print(loader_train.dataset[1])
#print

G = nx.Graph()
node_edge = loader_train.dataset[1].edge_index
node_edge = np.transpose(node_edge)
#print(node_edge)
G.add_edges_from(np.array(node_edge))
pos=nx.circular_layout(G)  # 生成圆形节点布局
plt.figure(figsize=(5, 5))
#nx.draw(G,pos,with_labels=True,node_size=200,node_color = 'b')  #with_labels=True节点上标有数字
nx.draw(G,pos =pos,with_labels=True,node_size=800,font_color = 'k',font_family = 'Times New Roman',font_size = 25)
